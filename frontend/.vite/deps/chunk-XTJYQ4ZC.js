...
function GlobalStyles3(props) {
  return (0, import_jsx_runtime12.jsx)(GlobalStyles_default, {
    ...props,
    defaultTheme: defaultTheme_default,
    themeId: identifier_default
  });
...
function globalCss(styles) {
  return function GlobalStylesWrapper(props) {
    return (
      ...
      (0, import_jsx_runtime13.jsx)(GlobalStyles_default2, {
...
var useUtilityClasses2 = (ownerState) => {
  ...
  const slots = {
    root: ["root", color !== "inherit" && `color${capitalize_default(color)}`, `fontSize${capitalize_default(fontSize2)}`]
  };
...
var SvgIcon = React31.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsxs)(SvgIconRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
    ...
    ownerState,
    children: [hasSvgAsChild ? children.props.children : children, titleAccess ? (0, import_jsx_runtime15.jsx)("title", {
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime16.jsx)(SvgIcon_default, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XTJYQ4ZC.js.map
